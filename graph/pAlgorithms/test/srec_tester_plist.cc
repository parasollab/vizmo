...
void stapl_main(int argc, char** argv) {
  ...
  TestManager tm;
  if (flag) {
    char* n_elet = argv[2]; argc=7; argv[1]="Tester_Recurrence1"; argv[2]="p"; argv[3]=n_elet; argv[4]="Tester_Recurrence2"; argv[5]="p"; argv[6]=n_elet;
  };
