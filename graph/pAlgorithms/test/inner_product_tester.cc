#include "inner_product_tester.h"
#include <assert.h>
#include <runtime.h>
...
public:
  ...
  void SetAllTesters() {
    Tester_Inner_Product* t0 = new Tester_Inner_Product();
...
void stapl_main(int argc, char** argv) {
  ...
  //translate to be "exe 10 Tester_InnerProduct b 50"
  char *p; char *space=" ";
  ...
  TestManager tm;
  if (flag) {
    char* n_elet = argv[3]; argc = 5; argv[2]="Tester_Inner_Product";  argv[3]="b"; argv[4]=n_elet;
  } 
