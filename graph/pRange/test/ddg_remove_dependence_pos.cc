...
void stapl_main(int argc, char **argv) {
  ...
  if (id == 0) {
    cout << "DDG remove_dependence positive with " 
         << nThreads << " threads... ";
  }
  ...
  sort(first_call.begin(), first_call.end());
  sort(second_call.begin(), second_call.end());
  ...
  correct_values1 = equal(first_call.begin(), first_call.end(), ans1.begin());
  correct_values2 = equal(second_call.begin(), second_call.end(), ans2.begin());
