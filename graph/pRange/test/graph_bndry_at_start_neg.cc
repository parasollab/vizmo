...
void stapl_main(int argc, char **argv) {
  ...
  if (id == 0) {
    cout << "graph boundary at_start negative with " 
         << nThreads << " threads... ";
  }
  ...
  // Test 1: Use a variable of the incorrect type as the argument.
  dumb d;
  bound.at_start(d);

  // Test 2: Use a variable of the incorrect type to store the return value.
  d = bound.at_start(bound.start());
