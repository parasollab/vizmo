...
stapl::exit_code stapl_main(int argc, char* argv[])
{
  ...
  STAPL_TEST_REPORT(res, "Testing binary_search");
  ...
  STAPL_TEST_REPORT(res, "Testing lower_bound");
  ...
  STAPL_TEST_REPORT(res, "Testing upper_bound");
  ...
  STAPL_TEST_REPORT(res, "Testing equal_range");
