...
//   pfp_t pfp1 (bind((pfun1_t) adjacent_find<view_type>, _1));
//   pfp_t pfp2 (bind((pfun2_t) adjacent_find<view_type, fun>, _1, fun()));

//   sfp_t sfp1 (bind((sfun1_t) adjacent_find<iterator_type>, _1, _2));
//   sfp_t sfp2 (bind((sfun2_t) adjacent_find<iterator_type, fun>,
//                    _1, _2, fun()));

//   const unsigned long int n_elems = set_data_size(n, ds, "nonmutating");

//   //fixme, none of these actually match...
//   // no match
//   timed_test_result tres1(name);
//   test_type(
//     data_descriptor<pcontainer_type, view_type, sequence<data_type> >(
...
//     data_descriptor<pcontainer_type, view_type, block_sequence<data_type> >(
//       n_elems, t.ct_create[0], t.vw_create[0],
//       block_sequence<data_type>(1, 3, 1)))
//     (tres3, i, pfp1, sfp1);
...
//     data_descriptor<pcontainer_type, view_type, block_sequence<data_type> >(
//       n_elems, t.ct_create[0], t.vw_create[0],
//       block_sequence<data_type>(1, 2, 1)))
//     (tres5, i, pfp1, sfp1);
...
*/
  ...
  // find_first_of is slow due to remote element access.
...
/*   timed_test_result tres4(name);
   test_type(
     ...
     data_descriptor<pcontainer_type, view_type, sequence<data_type> >(
       1, t.ct_create[1], t.vw_create[1], sequence<data_type>(-1, 0)))
     (tres4, i, pfp2, sfp2, iterator_alt_tag());*/
  // multiple match
/*   timed_test_result tres5(name);
   test_type(
     data_descriptor<pcontainer_type, view_type, block_sequence<data_type> >(
...
/*
   ...
   test_type(
     ...
     data_descriptor<pcontainer_type, view_type, sequence<data_type> >(
       1, t.ct_create[1], t.vw_create[1], sequence<data_type>(1, 0)))
     (tres6, i, pfp2, sfp2, iterator_alt_tag());
*/
...
//   pfp_t pfp1(bind((pfun1_t) mismatch<view_type, view_type>, _1, _2));
//   sfp_t sfp1(bind((sfun1_t) mismatch<iterator_type, iterator_type>,
//                   _1, _2, _3));
//   pfp_t pfp2(bind((pfun2_t) mismatch<view_type, view_type, comp>,
//                   _1, _2, comp()));
//   sfp_t sfp2(bind((sfun2_t) mismatch<iterator_type, iterator_type, comp>,
//                   _1, _2, _3, comp()));
...
//     (bind((pfun1_t) search<view_type, view_type>, _1, _2));

//   function<iterator_type (iterator_type, iterator_type, iterator_type,
//                           iterator_type)> sfp1
//     (bind((sfun1_t) search<iterator_type, iterator_type>, _1, _2, _3, _4));

//   function<ret_type (view_type const&, view_type const&)> pfp2
//     (bind((pfun2_t) search<view_type, view_type, fun>, _1, _2, fun()));

//   function<iterator_type (iterator_type, iterator_type, iterator_type,
//                           iterator_type)> sfp2
//     (bind((sfun2_t) search<iterator_type, iterator_type, fun>,
//           _1, _2, _3, _4, fun()));
...
//       n_elems, t.ct_create[0], t.vw_create[0], sequence<data_type>(1, 1)),
//     data_descriptor<pcontainer_type, view_type, sequence<data_type> >(
//       2, t.ct_create[1], t.vw_create[1], sequence<data_type>(1, 0)))
//     (tres1, i, pfp1, sfp1, iterator_alt_tag());
...
//     data_descriptor<pcontainer_type, view_type, sequence<data_type> >(
//       2, t.ct_create[1], t.vw_create[1], sequence<data_type>(1, 0)))
//     (tres2, i, pfp2, sfp2, iterator_alt_tag());
...
//     (tres3, i, pfp1, sfp1, iterator_alt_tag());
...
//     (tres5, i, pfp1, sfp1, iterator_alt_tag());
...
//     (tres7, i, pfp2, sfp2, iterator_alt_tag());

//   test_report(tres1&tres2&tres3&tres4&tres5&tres6&tres7);
// }
...
//   typedef ret_type (*pfun1_t)(view_type const&, int, data_type const&);
//   typedef ret_type (*pfun2_t)(view_type const&, int, data_type const&, fun);
...
//   pfp_t pfp1(bind((pfun1_t) search_n<view_type, int, data_type>, _1, 2, 0));
//   pfp_t pfp3(bind((pfun1_t) search_n<view_type, int, data_type>,
//                   _1, 1, elem));
//   pfp_t pfp5(bind((pfun1_t) search_n<view_type, int, data_type>, _1, 21, 7));

//   pfp_t pfp2(bind((pfun2_t) search_n<view_type, int, data_type, fun>,
//                   _1, 2, 0, fun()));
//   pfp_t pfp4(bind((pfun2_t) search_n<view_type, int, data_type, fun>,
//                   _1, 1, elem, fun()));
//   pfp_t pfp6(bind((pfun2_t) search_n<view_type, int, data_type, fun>,
//                   _1, 21, 7, fun()));

//   sfp_t sfp1(bind((sfun1_t) search_n<iterator_type, int, data_type>,
//                   _1, _2, 2, 0));
//   sfp_t sfp3(bind((sfun1_t) search_n<iterator_type, int, data_type>,
//                   _1, _2, 1, elem));
//   sfp_t sfp5(bind((sfun1_t) search_n<iterator_type, int, data_type>,
//                   _1, _2, 21, 7));

//   sfp_t sfp2(bind((sfun2_t) search_n<iterator_type, int, data_type, fun>,
//                   _1, _2, 2, 0, fun()));
//   sfp_t sfp4(bind((sfun2_t) search_n<iterator_type, int, data_type, fun>,
//                   _1, _2, 1, elem, fun()));
//   sfp_t sfp6(bind((sfun2_t) search_n<iterator_type, int, data_type, fun>,
//                   _1, _2, 21, 7, fun()));
...
//   function<ret_type (view_type const&, view_type const&)> pfp1
//     (bind((pfun1_t) find_end<view_type, view_type>, _1, _2));

//   function<iterator_type (iterator_type, iterator_type, iterator_type,
//            iterator_type)> sfp1
//     (bind((sfun1_t) find_end<iterator_type, iterator_type>, _1, _2, _3, _4));

//   function<ret_type (view_type const&, view_type const&)> pfp2
//     (bind((pfun2_t) find_end<view_type, view_type, fun>, _1, _2, fun()));

//   function<iterator_type (iterator_type, iterator_type, iterator_type,
//            iterator_type)> sfp2
//     (bind((sfun2_t) find_end<iterator_type, iterator_type, fun>,
//           _1, _2, _3, _4, fun()));
