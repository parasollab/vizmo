...
stapl::exit_code stapl_main(int argc,char** argv)
{
  ...
  test_community_detection<graph_view_t>(nx, ny);
  test_community_detection_h<graph_view_t>(nx, ny);
  test_community_detection_h_hubs<graph_view_t>(nx, ny);
