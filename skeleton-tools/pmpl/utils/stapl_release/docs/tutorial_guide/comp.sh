#
###='-I/opt/stapl/tools/libstdc++/4.8.2 -I/opt/stapl/tools -I/opt/stapl -I/usr/local/boost/boost-1.56/include'
###=-L/opt/stapl/lib -lstapl -lrt -L/usr/local/boost/boost-1.56/lib64 -lboost_serialization -lboost_system'
#INC='-DSTAPL_NDEBUG -I/opt/stapl/tools/libstdc++/4.8.2 -I/opt/stapl/tools -I/opt/stapl/include -I/opt/stapl -I/usr/local/boost/boost-1.56/include'
#LINK='-L/opt/stapl/lib -lstapl -lrt -lboost_serialization -lboost_system'
#COMP='/usr/lib64/openmpi/bin/mpic++'
#OPT='-D_STAPL -std=c++11 -O3'

INC='-D_STAPL -I/users/rmetzger/stapl/trunk/./tools/libstdc++/4.8.3 -I/users/rmetzger/stapl/trunk/tools -I/users/rmetzger/stapl/trunk -I/usr/local/boost/boost-1.56/include -DBOOST_RESULT_OF_USE_TR1_WITH_DECLTYPE_FALLBACK -fno-color-diagnostics -DSTAPL__GNUC__=4 -DSTAPL__GNUC_MINOR__=8 -DSTAPL__GNUC_PATCHLEVEL__=3 -gcc-toolchain /usr/ -ftemplate-depth=512 -Wno-constexpr-not-const'

OPT='-g -std=c++11 -O3' # -DSTAPL_NDEBUG 
LINK='-g -L/opt/stapl/lib -lstapl_debug -lrt -L/usr/local/boost/boost-1.56/lib64 -lboost_serialization -lboost_thread -lboost_system'
