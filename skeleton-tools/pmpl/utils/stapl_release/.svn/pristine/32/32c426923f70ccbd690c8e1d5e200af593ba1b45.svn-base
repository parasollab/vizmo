...
struct allreduce_object_bench_wf
{
  typedef void          result_type;
  typedef double        value_type;
  typedef A<value_type> object_type;
  ...
  static std::string name(void)
  { return std::string("allreduce_object(c)"); }

  object_type                                                     obj;
  stapl::runtime::allreduce_object<double, std::plus<value_type>> ar;

  allreduce_object_bench_wf(void)
