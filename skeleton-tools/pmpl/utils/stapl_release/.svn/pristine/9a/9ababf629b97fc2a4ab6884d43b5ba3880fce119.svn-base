...
public:
  ...
  runqueue_impl& get_impl(void) noexcept
  { return *m_impl; }
...
private:
  class shared_runqueue_impl;

  std::unique_ptr<shared_runqueue_impl> m_impl;
...
public:
  ...
  shared_runqueue_impl& get_impl(void) noexcept
  { return *m_impl; }
