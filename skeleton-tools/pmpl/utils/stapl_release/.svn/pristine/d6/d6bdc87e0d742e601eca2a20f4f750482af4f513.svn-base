...
public:
  ...
  //////////////////////////////////////////////////////////////////////
  /// @todo std::distance returns difference_type which is signed. Either
  ///       assert() or have an if for the the cast a.m_pointer<b.m_pointer
  //////////////////////////////////////////////////////////////////////
  size_type distance(index_type const& a, index_type const& b) const
  {
    return std::distance(a.m_pointer, b.m_pointer);
  }
