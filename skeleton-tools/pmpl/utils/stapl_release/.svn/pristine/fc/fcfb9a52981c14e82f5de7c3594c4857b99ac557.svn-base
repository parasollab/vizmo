...
struct count_cores_wf
{
  ...
  { return v.property().second == false; }
};


struct kc_helper
{
  typedef stapl::multidigraph<std::pair<int, bool> >  graph_t;
...
struct kc_hubs_helper
{
  ...
  size_t operator()(Graph& g, HGraph& h, HubsGraph& hubs)
  {
    ...
    stapl::k_core_h(g, h, hubs, m_core_sz);
