...
protected:
  ...
  struct graph_visitor
  {
    ...
    /// @ingroup pgraphAlgoDetails
    //////////////////////////////////////////////////////////////////////
    template<class Vertex, class NeighborOp, class Predicate>
    void visit_edge_if(Vertex source, NeighborOp&& uf, Predicate&& f) const
    {
      typedef typename Vertex::adj_edge_iterator iter_t;
...
public:
  ...
  result_type operator()(PGV& pgv, Vertex v, View& g)
  {
    ...
    return m_wf.template operator()<Vertex, visitor_t const&>
...
/// @tparam VertexOp Type of the user provided work function.
//////////////////////////////////////////////////////////////////////
template<bool AvoidHubs, class GraphView, class VertexOp>
class vertex_operator_apply
  : public vertex_operator_apply_base<AvoidHubs, GraphView, VertexOp,
      vertex_operator_apply<AvoidHubs, GraphView, VertexOp>
    >
{
...
/// @tparam VertexOp Type of the user provided work function.
//////////////////////////////////////////////////////////////////////
template<class GraphView, class VertexOp>
class vertex_operator_apply<true, GraphView, VertexOp>
  : public vertex_operator_apply_base<true, GraphView, VertexOp,
      vertex_operator_apply<true, GraphView, VertexOp>
    >
{
...
public:
  ...
  vertex_operator_apply(Op&& wf, size_t curr_level, size_t max_level,
    ...
    : base_type(std::forward<Op>(wf), curr_level, max_level),
