...
public:
  ...
  typedef proxy<typename value_type::property_type,
                property_accessor<container> > property_reference;

  typedef proxy<typename value_type::property_type,
                property_accessor<container> > const_property_reference;
...
public:
  ...
  property_reference property(void)
  {
    return property_reference(property_accessor<container>(this->m_container,
                                                           this->m_gid));
  }
