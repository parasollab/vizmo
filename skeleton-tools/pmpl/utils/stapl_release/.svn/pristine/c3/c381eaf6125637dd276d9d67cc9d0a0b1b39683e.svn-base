...
//////////////////////////////////////////////////////////////////////
template<int Index, int FixedIndex, typename T>
struct rewire_check
{
...
//////////////////////////////////////////////////////////////////////
template<int FixedIndex, typename T,
         typename = make_index_sequence<tuple_size<T>::value>>
struct rewire_dimension;


template<int FixedIndex, typename T, std::size_t... GIDIndices>
...
template<int D, typename Container>
...
/// for extended_view.
//////////////////////////////////////////////////////////////////////
template<typename Container, typename Domain, int FixedDim, typename Index>
struct coarsening_traits<multiarray_view<Container, Domain,
                           detail::rewire_dimension<FixedDim, Index>>>
{
...
make_extended_view(Container const& ct, std::size_t size)
{
