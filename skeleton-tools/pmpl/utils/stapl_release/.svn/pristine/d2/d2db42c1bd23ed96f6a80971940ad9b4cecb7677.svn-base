...
/// (@ref breadth_first_search_h()) for better scalability.
//////////////////////////////////////////////////////////////////////
...
struct bfs_helper
{
  ...
  size_t operator()(Graph& g)
  {
    ...
    size_t levels = stapl::breadth_first_search(g, source);
...
struct bfs_h_helper
{
  ...
  size_t operator()(Graph& g, HGraph& h)
  {
    ...
    size_t levels = stapl::breadth_first_search_h(g, h, source);
...
struct bfs_h2_helper
{
  ...
  size_t operator()(Graph& g, H1Graph& h1, H2Graph& h2)
  {
    ...
    size_t levels = stapl::breadth_first_search_h2(g, h1, h2, source);
...
struct bfs_hubs_helper
{
  ...
  size_t operator()(Graph& g, HGraph& h, HubsGraph& hubs)
  {
    ...
    size_t levels = stapl::breadth_first_search_h(g, h, hubs, source);
