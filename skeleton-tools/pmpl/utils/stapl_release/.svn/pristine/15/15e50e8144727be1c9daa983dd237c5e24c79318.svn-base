...
//////////////////////////////////////////////////////////////////////
/// @brief Predicate to order two edges by target.
/// @ingroup pgraphAlgoDetails
//////////////////////////////////////////////////////////////////////
struct comp_target
{
...
//////////////////////////////////////////////////////////////////////
/// @brief Predicate to check if targets of two edges are same.
/// @ingroup pgraphAlgoDetails
//////////////////////////////////////////////////////////////////////
struct same_target
{
...
struct children_inform_supervertex_wf
{
  ...
  void operator()(Vertex v)
  {
    ...
    delete_cross_partition_edges(v);
  }

  template<typename Vertex>
  void delete_initial_edges(Vertex v) const
  {
    if (m_delete_edges) {
      std::sort(v.begin(), v.end(), comp_target());
      auto new_end = std::unique(v.begin(), v.end(), same_target());
  ...
  template<typename Vertex>
  void delete_cross_partition_edges(Vertex v) const
  {
    if (m_delete_edges) {
      m_post_process(v, m_is_local);
      auto new_end = remove_if(v.begin(), v.end(), m_is_local);
      v.erase(new_end-v.begin());
    }
  }
                     ...
                     size_t max_msg_sz = 512)
{
  ...
  typedef is_local_0<lower_level_cont_t> locality_func_t;
