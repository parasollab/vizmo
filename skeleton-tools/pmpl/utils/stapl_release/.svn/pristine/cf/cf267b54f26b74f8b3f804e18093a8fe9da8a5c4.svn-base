...
public:
  ...
  /// notifier list
  ///
  /// @param executor The executor associated with the given PARAGRAPH.
  /// @param b_migration_enabled Denotes whether the PARAGRAPH has task
  /// migration support enabled.
  //////////////////////////////////////////////////////////////////////
  void set_signal(executor_base& executor, const bool b_migration_enabled)
  {
    m_signal_version.set_value(executor, b_migration_enabled, is_persistent());
  }
