...
struct static_array_traits
{
  ...
  typedef balanced_partition<indexed_domain<size_t> >   partition_type;
  ...
  typedef basic_manager                                 manager_type;
  ...
  typedef container_manager_static<base_container_type> container_manager_type;
