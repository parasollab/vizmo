...
{
  typedef distributed_domain<Distribution>       domain_type;
  typedef typename Distribution::
                   base_container_type::
                   domain_type::field_selector   field_selector;

  typedef iterator_domain<Distribution,
                          field_selector>        metadata_domain_type;
};
