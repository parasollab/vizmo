...
//////////////////////////////////////////////////////////////////////
/// @brief Container transformation metafunction with purpose same as
...
template<template<typename...> class View,
         typename NewC, typename ...Params>
struct new_cast_container_view<View<Params...>, NewC>
{
  typedef compose_map_func<
    typename view_traits<View<Params...>>::map_function,
    typename view_traits<View<Params...>>::container
  >                                                         mapfunc_composer;

  typedef typename retype_ct_mf<
    View<Params...>, NewC, typename mapfunc_composer::type
  >::type                                                   type;

  typename mapfunc_composer::type mapfunc(View<Params...> const& view)
  {
...
///        containers.
///
///        This is used during the creation of @ref nfast_view for a task
///        in a PARAGRAPH.
//////////////////////////////////////////////////////////////////////
template<typename View, typename C>
