...
private:
  typedef typename coarsen_partition_impl::
                   coarsen_partition<View>::return_type     native_part_type;
...
public:
  ...
  native_partition(View const& view)
    : m_view(view),
      m_part(
        coarsen_partition_impl::coarsen_partition<View const>::apply(&view))
  { }
