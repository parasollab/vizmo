...
/// @tparam Elem The type of the edge descriptors for edges being added.
/// @tparam Cont The type of the container (graphs).
/// @tparam AddEdgeWf The type of the functor to execute on (graphs).
/// @ingroup pgraphAlgoDetails
//////////////////////////////////////////////////////////////////////
template<typename Elem, typename Cont,
         typename AddEdgeWf = aggr_algo_detail::add_edge_wf>
struct add_edge_aggregator
  : public aggregator_apply_impl<Elem, Cont, AddEdgeWf,
                                 add_edge_aggregator<Elem, Cont, AddEdgeWf> >
{
  typedef aggregator_apply_impl<Elem, Cont, AddEdgeWf,
                                add_edge_aggregator<Elem, Cont, AddEdgeWf> >
    base_type;
  ...
  //////////////////////////////////////////////////////////////////////
  size_t target_location(Elem const& x)
