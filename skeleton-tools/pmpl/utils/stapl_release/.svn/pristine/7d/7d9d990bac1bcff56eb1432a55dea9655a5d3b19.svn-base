...
class elem
  : public Skeleton,
    public dimensions_metadata_type<Span>
{
public:
...
public:
  ...
  void set_dimensions(Spawner const& spawner, VSizes const& view_sizes)
  {
    m_span.set_size(spawner, view_sizes);
  ...
  {
    return ports_t(*this).template out_port<In>(lid_offset);
  }
