...
protected:
  ...
  //////////////////////////////////////////////////////////////////////
  void insert_local(gid_type const& gid, value_type const& val,
                    rmi_handle::reference const& view_handle)
  {
    this->distribution().insert(gid, val, view_handle);
  }
  ...
  //////////////////////////////////////////////////////////////////////
  void erase_local(gid_type const& gid,
                   rmi_handle::reference const& view_handle)
  {
    this->distribution().erase(gid, view_handle);
  }
...
public:
  ...
  //////////////////////////////////////////////////////////////////////
  void insert(gid_type const& gid, value_type const& val,
              rmi_handle::reference const& view_handle=rmi_handle::reference())
  {
    ...
    if (this->get_location_id() != 0)
      async_rmi(0, this->get_rmi_handle(), &vector::insert_local, gid, val,
          view_handle);
    else
      this->distribution().insert(gid, val, view_handle);
  }
             ...
             rmi_handle::reference const& view_handle=rmi_handle::reference())
  {
    this->incr_version();
    if (this->get_location_id() != 0)
      async_rmi(0, this->get_rmi_handle(), &vector::erase_local, gid,
          view_handle);
    else
      this->distribution().erase(gid, view_handle);
  }
  ...
  ///
  /// @note The method is only available in vector instances that use
