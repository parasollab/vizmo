...
void generate_benchmark_input(G& g, size_t nv, size_t nedges)
{
  ...
  {
    add_edge_aggregator<typename G::edge_descriptor, G>
      add_edge_aggr(&g, MAX_EDGE_AGGR_MSG_SZ);
    size_t s,t;
...
{
  typedef stapl::multidigraph<stapl::properties::page_rank_property> PGR_static;
