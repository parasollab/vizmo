...
public:
  ...
  //////////////////////////////////////////////////////////////////////
  template<typename T>
  T const& deduce_payload_offset(void) noexcept
  {
...
//////////////////////////////////////////////////////////////////////
/// @brief Returns a @ref message_ptr from a pointer to @ref message.
///
/// @warning This function checks the reference count and creates a clone of
/// @p m if it is not @c 1. This may cause performance degradation if it is
/// known that the reference count is always @c 1.
///
/// @ingroup requestBuildingBlock
//////////////////////////////////////////////////////////////////////
