                  ...
                  InputIterator first, InputIterator last)
{
  ...
  try {
    ...
    std::vector<traits_type::ct_t>
      cct(3, bind(allocate_balanced_container, _1));
    std::vector<traits_type::vw_t> cvt(3, bind(allocate_aligned_view, _1));
    ...
    if (vm.count("cpart"))
    {
      ...
      if (part_spec[0] == "balanced")
        cct[0] = bind(allocate_balanced_container, _1);
      else if (part_spec[0] == "block")
      {
        cct[0] = bind(allocate_blocked_container, _1,
    ...
    else
    {
      if (vm.count("cpart1"))
      {
        ...
        if (part_spec[0] == "balanced")
          cct[1] = bind(allocate_balanced_container, _1);
        else if (part_spec[0] == "block")
        {
          cct[1] = bind(allocate_blocked_container, _1,
                        std::atoi(part_spec[1].c_str()));
        }
      }
      if (vm.count("cpart2"))
      {
        ...
        if (part_spec[0] == "balanced")
          cct[2] = bind(allocate_balanced_container, _1);
        else if (part_spec[0] == "block")
        {
          cct[2] = bind(allocate_blocked_container, _1,
                        std::atoi(part_spec[1].c_str()));
        }
      }
    }
