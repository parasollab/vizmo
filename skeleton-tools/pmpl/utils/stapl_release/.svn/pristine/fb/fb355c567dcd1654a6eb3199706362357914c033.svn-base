...
///
/// For example, giving a 1D container with domain [0..3], the periodic
/// boundary view will have domain of [0..5] and mapping function as follows:
///
/// 0 --> 3
/// 1 --> 0
/// 2 --> 1
...
public:
  ...
  //////////////////////////////////////////////////////////////////////
  /// Initialize domain (and copy passed to mapping function) with adjusted
  /// version of domain underlying container.
  //////////////////////////////////////////////////////////////////////
