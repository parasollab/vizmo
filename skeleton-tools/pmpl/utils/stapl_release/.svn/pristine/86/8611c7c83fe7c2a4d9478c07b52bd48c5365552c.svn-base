...
public:
  ...
  constexpr rmi_handle_info(void* const p,
                            const epoch_type epoch,
                            const gang_id gid) noexcept
  : m_internal_handle(p),
    m_registration_epoch(epoch),
    m_epoch(epoch),
    m_gid(gid)
  { }

  constexpr rmi_handle_info(const object_id id,
                            const epoch_type epoch,
                            const gang_id gid) noexcept
  : m_internal_handle(id),
    m_registration_epoch(epoch),
    m_epoch(epoch),
    m_gid(gid)
  { }
...
///        @ref stapl::runtime::object_virtual_address.
///
