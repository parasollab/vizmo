...
class coloring_property
{
 ...
 public:
  ...
  coloring_property(coloring_property const& other)
...
public:
  page_rank_property(void)
    : m_color(0.0), m_color2(0.0), m_active(true)
  { }
...
public:
  ...
  topological_sort_property(topological_sort_property const& other)
    : m_rank(other.m_rank), m_preds(other.m_preds)
  { }
...
template <typename Accessor>
class proxy<properties::lp_property, Accessor>
  : public Accessor
{
private:
  friend class proxy_core_access;
  typedef properties::lp_property target_t;

public:
  typedef target_t::desc_t desc_t;
  typedef target_t::link_probabilities_t link_probabilities_t;
  typedef target_t::step_2_buffer_t step_2_buffer_t;
  typedef target_t::step_3_buffer_t step_3_buffer_t;
...
template <typename Accessor>
class proxy<properties::page_rank_property, Accessor>
  : public Accessor
{
private:
  friend class proxy_core_access;
  typedef properties::page_rank_property target_t;
  typedef target_t::value_type value_type;
