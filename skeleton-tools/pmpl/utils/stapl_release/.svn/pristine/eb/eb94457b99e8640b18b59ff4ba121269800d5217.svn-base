...
//////////////////////////////////////////////////////////////////////
/// @brief Work function to reduce pairs of min/max elements.
/// @tparam T The type of the values being compared.
/// @ingroup comparatorFunctionObjects
///
/// The function accepts pairs containing elements of type T, and returns
/// a pair containing the min of the first elements, and max of the second
/// elements.
//////////////////////////////////////////////////////////////////////
template<typename T, typename Pred>
class minmax
  : public ro_binary_function<T, T, std::pair<T,T>>
{
  Pred m_pred;
...
public:
  ...
  result_type operator()(Reference1 x, Reference2 y) const
  {
    return std::make_pair(
      m_pred(x.first, y.first) ? x.first : y.first,
      !m_pred(x.second, y.second) ? x.second : y.second
    );
  }
...
#define STAPL_DEFINE_IDENTITY_VALUE_minmax(TYPE)             \
template<typename Pred>                                      \
struct identity_value<minmax<TYPE, Pred>, char>              \
{                                                            \
  static std::pair<TYPE, TYPE> value(void)                   \
  {                                                          \
    return std::make_pair(std::numeric_limits<TYPE>::max(),  \
                          std::numeric_limits<TYPE>::min()); \
  }                                                          \
};

STAPL_DEFINE_IDENTITY_VALUE_minmax(char)
STAPL_DEFINE_IDENTITY_VALUE_minmax(unsigned char)
STAPL_DEFINE_IDENTITY_VALUE_minmax(int)
STAPL_DEFINE_IDENTITY_VALUE_minmax(unsigned int)
STAPL_DEFINE_IDENTITY_VALUE_minmax(long int)
STAPL_DEFINE_IDENTITY_VALUE_minmax(long unsigned int)
STAPL_DEFINE_IDENTITY_VALUE_minmax(float)
STAPL_DEFINE_IDENTITY_VALUE_minmax(double)
...
//////////////////////////////////////////////////////////////////////
/// @brief Work function which returns the minimum of two values using the
///   provided comparator.
/// @tparam T Type of values being compared.
...
//////////////////////////////////////////////////////////////////////
/// @brief Work function which returns the maximum of two values using the
///   provided comparator.
/// @tparam T Type of values being compared.
...
//////////////////////////////////////////////////////////////////////
/// @brief Work function which reduces two values to the minimum value using
///   the provided comparator.
/// @tparam T Type of values being compared.
/// @tparam Comparator Comparison function which is called to determine the min.
/// @ingroup comparatorFunctionObjects
/// @todo Template parameter T appears to be unused.
//////////////////////////////////////////////////////////////////////
template<typename T, typename Comparator>
struct min_element_reduce
{
  Comparator m_compare;

  min_element_reduce(Comparator const& cmp)
    : m_compare(cmp)
  { }

  template<typename Reference1, typename Reference2>
  Reference1 operator()(Reference1 a, Reference2 b) const
  {
    if (m_compare(b, a))
      return b;
    else
...
//////////////////////////////////////////////////////////////////////
/// @brief Work function which reduces two values to the maximum value using
///   the provided comparator.
/// @tparam T Type of values being compared.
/// @tparam Comparator Comparison function which is called to determine the max.
/// @ingroup comparatorFunctionObjects
...
struct max_element_reduce
{
  ...
  max_element_reduce(Comparator const& cmp)
    : m_compare(cmp)
  { }
...
//////////////////////////////////////////////////////////////////////
/// @brief Work function which calls @c std::swap on its arguments.
/// @ingroup mutatingFunctionObjects
//////////////////////////////////////////////////////////////////////
struct swap2
{
    ...
    private Predicate
{
  ...
  explicit
  unary_negate(Predicate const& pred)
    : Predicate(pred)
  { }
...
//////////////////////////////////////////////////////////////////////
/// @brief Function which returns a pair containing the duplicated result of
///   calling the given predicate on its argument.
/// @tparam T Type of the argument.
/// @tparam Pred Predicate function which is called on the argument.
/// @ingroup functionObjects
//////////////////////////////////////////////////////////////////////
template<typename T>
struct element_to_pair_map
  : public ro_unary_function<T, std::pair<T,T> >
{
