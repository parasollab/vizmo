...
struct graph_distribution
  : public distribution<Container>,
    public operations::base<graph_distribution<Container> >,
...
public:
  ...
  void aggregate_apply_async(Cont const& cont, F const& f)
  {
    for (typename Cont::const_iterator it = cont.begin();
         it != cont.end();
         ++it)
      this->apply_set(it->target(), f);
  }

  //////////////////////////////////////////////////////////////////////
  /// @copydoc directed_graph_base::aggregate_apply_async(size_t const&, Cont const&, F const&)
  //////////////////////////////////////////////////////////////////////
  template<typename Cont, typename F>
  ...
  {
    this->apply_set(gid, detail::extract_property_apply<F>(f));
  }
