...
{
private:
  class STAPL_RUNTIME_CACHELINE_ALIGNED element_storage_type
  : public async_result<T>
  { };

  typedef std::vector<element_storage_type>           container_type;
public:
  typedef typename container_type::size_type          size_type;
  typedef typename element_storage_type::storage_type storage_type;
