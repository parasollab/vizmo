...
struct container_traits<multiarray_base_container<T, Domain, CID, Traits> >
{
  ...
  typedef local_accessor<
    multiarray_base_container<T, Domain, CID, Traits>
  >                                                      accessor_t;
...
public:
  ...
  multiarray_base_container(domain_type const& domain, cid_type const& cid,
    ...
    : m_domain(domain), m_data(m_domain.size(), default_value), m_cid(cid),
      m_linear_mf(m_domain.dimensions(), m_domain.first())
  { }
...
public:
  ...
  basic_multiarray_base_container(domain_type const& dom, cid_type const& cid)
    : base_t(dom, cid)
  { }
