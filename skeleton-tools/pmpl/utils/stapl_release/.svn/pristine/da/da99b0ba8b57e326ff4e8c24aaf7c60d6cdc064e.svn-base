...
public:
  ...
  adjacent_diff (Functor const& f)
    : m_f(f)
  { }

  //////////////////////////////////////////////////////////////////////
  /// @brief Compute the difference of two elements.
  /// @param x One-dimensional view of two adjacent elements of the view
  ///   provided to the adjacent_difference function.
  /// @param y Reference of a single element of the output view provided to the
  ///   adjacent_difference function.
  /// @param i Offset of elements @p x and @p y in the sequences being processed
  //////////////////////////////////////////////////////////////////////
  template<typename View1, typename View2, typename Index>
  void operator()(View1 x, View2 y, Index i) const
  {
    *(y.begin()+1) = m_f(*(x.begin()+1),*(x.begin()));
    if (i == 0)
      *(y.begin()) = *(x.begin());
  }
...
inline
void adjacent_difference(View1 const& view1,View2 const& view2, Oper oper)
{
  stapl::map_func(algo_details::adjacent_diff<Oper>(oper),
                  make_overlap_view(view1, 1, 0, 1),
                  make_overlap_view(view2, 1, 0, 1),
                  counting_view<int>(view2.size()-1));
}
...
inline
void adjacent_difference(View1 const& view1,View2 const& view2)
{
