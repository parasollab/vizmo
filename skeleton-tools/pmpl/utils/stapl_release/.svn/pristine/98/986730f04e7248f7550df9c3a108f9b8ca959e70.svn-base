...
stapl::exit_code stapl_main(int argc, char* argv[])
{
  ...
  stapl::unordered_map_partition<
    pair_hash<key_type, stapl::hash<key_type> >,
    continuous_domain<multi_key<key_type> >
  > const&                                         mypart(get_num_locations());
  //stapl::indexed_domain<size_t>                    dom(0, n-1);
