...
/// incremental behavior while releasing memory as quickliy as possible back
/// to the system.
//////////////////////////////////////////////////////////////////////
template<typename T>
...
{
private:
  enum storage_state { uninitialized, direct_storage,
                       wrapped, stolen };
...
public:
               ...
               const bool b_persistent)
  {
    this->add_notifier_impl(
      [&executor, this](Notifier const& notifier)
        { notifier(executor, this->value()); },
                 ...
                 const bool b_persistent)
  {
    ...
    this->flush_notifications(
      [&executor, this](Notifier& notifier)
        { notifier(executor, this->value()); },
      b_persistent);
...
public:
  ...
  {
    this->add_notifier_impl(
      [&executor](Notifier const& notifier) { notifier(executor); },
      notifier, b_persistent);
  }
  ...
  //////////////////////////////////////////////////////////////////////
  void set_value(executor_base& executor,
                 const bool b_migration_enabled,
                 const bool b_persistent)
  {
    ...
    this->flush_notifications(
      [&executor](Notifier& notifier) { notifier(executor); }, b_persistent);
...
public:
  ...
  void set_value(ValueParam&& val, executor_base& executor,
                 bool b_migration_enabled, bool b_persistent)
  {
    ...
    this->flush_notifications(
      [&executor, this](notifier_t& notifier)
        { notifier(executor, this->value()); },
      b_persistent);
  ...
  //////////////////////////////////////////////////////////////////////
  void set_value_full(FullEdge const& val, executor_base& executor,
                      bool b_migration_enabled, bool b_persistent)
  {
    ...
    if (this->test_flow())
    {
     ...
     this->set_value(static_cast<Filter&>(*this)(val),
                     executor, b_migration_enabled, b_persistent);
  }
               ...
               bool b_persistent)
  {
    ...
    this->add_notifier_impl(
      [&executor, this](notifier_t const& notifier)
        { notifier(executor, this->value()); },
      notifier, b_persistent);
...
public:
  ...
  void set_value(ValueParam&& val, unsigned int index, executor_base& executor,
                 bool b_migration_enabled, bool b_persistent,
                 bool b_expect_exist)
  {
                      ...
                      bool b_persistent)
  {
    for (auto&& version_entry : m_versions)
      version_entry.set_value_full(
        val, executor, b_migration_enabled, b_persistent);
  }
