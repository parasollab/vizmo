...
{
  using type = typename Op::first_argument_type;
};
...
{
  using type = typename Op::result_type;
};
  ...
  : public decltype(
             skeletons::compose<flows::compose_flows::input_to_all>(
               skeletons::binary_tree<
                 ...
                 spans::nearest_pow_2<spans::balanced<>>, true
               >(std::declval<Op>()),
               skeletons::reverse_tree<
                 2, flows::repeat_flows::scan_broadcast,
                 spans::reverse_tree<
                   spans::nearest_pow_2<spans::balanced<>>, tags::left_skewed
                 >
  ...
  using base_type = decltype(
                      skeletons::compose<flows::compose_flows::input_to_all>(
                        ...
                        skeletons::reverse_tree<
                          2, flows::repeat_flows::scan_broadcast,
                          spans::reverse_tree<
                            spans::nearest_pow_2<spans::balanced<>>,
                            tags::left_skewed
                          >
                        >(skeletons::scan_broadcast_pd(std::declval<Op>()))));
  ...
  : public decltype(
             ...
             >(skeletons::binary_tree<
               ...
               skeletons::reverse_tree<
                 2, flows::repeat_flows::scan_broadcast,
                 spans::reverse_tree<
                   spans::nearest_pow_2<spans::balanced<>>, tags::right_aligned
                 >
