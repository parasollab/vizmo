...
struct cleanup_elements
{
  ...
  static void apply(GraphStorage&)
  { }
};
...
{
  template<typename GraphStorage>
  static void apply(GraphStorage& g)
  {
...
public:
  ...
  {
    return this->m_data.add_vertex(v);
  }
  ...
  {
    return this->m_data.add_vertex(gid, v);
  }
  ...
  {
    f.template operator()<value_type&>(*(m_data.find_vertex(gid)));
  }
