...
#ifndef STAPL_BENCHMARKS_NAS_FLOWS_TRANSPOSE_3D_HPP
#define STAPL_BENCHMARKS_NAS_FLOWS_TRANSPOSE_3D_HPP
...
struct transpose_3d
{
  ...
  public:
    using in_port_size = std::integral_constant<int, 5>;
    ...
    in_port(std::size_t lid_offset)
    {
      return concat(
        ...
        std::make_tuple(
          std::get<2>(m_compose.template get_in_port<0>(lid_offset))),
        std::make_tuple(
...
#endif // STAPL_BENCHMARKS_NAS_FLOWS_TRANSPOSE_3D_HPP
