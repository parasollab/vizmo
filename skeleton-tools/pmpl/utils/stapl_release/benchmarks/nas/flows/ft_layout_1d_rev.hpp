...
#ifndef STAPL_BENCHMARKS_NAS_FLOWS_FT_LAYOUT_1D_REV_HPP
#define STAPL_BENCHMARKS_NAS_FLOWS_FT_LAYOUT_1D_REV_HPP
...
struct ft_layout_1d_rev
{
  ...
  public:
    ...
    {
    public:
      using type = typename inner_ports_types<In>::out_port_3_type;
    };
...
#endif // STAPL_BENCHMARKS_NAS_FLOWS_FT_LAYOUT_1D_REV_HPP
