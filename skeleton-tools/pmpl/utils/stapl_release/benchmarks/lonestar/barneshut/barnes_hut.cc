...
stapl::exit_code stapl_main(int argc, char* argv[])
{
  ...
  typedef array<particle>                          container_type;
  typedef array_view<container_type>               view_type;
  typedef functor_view_type<random_particle, 1>::type random_view_type;
  ...
  bool any_moved = !equal(particle_view, original_particles);
