...
/// (@ref page_rank_h()) for better scalability.
//////////////////////////////////////////////////////////////////////
...
struct pr_helper
{
  typedef stapl::multidigraph<stapl::properties::page_rank_property>  graph_t;
...
struct pr_h_helper
{
  ...
  size_t operator()(Graph& g, HGraph& h)
  {
    ...
    return stapl::page_rank_h(g, h, m_num_iter);
  }
...
struct pr_hubs_helper
{
  ...
  size_t operator()(Graph& g, HGraph& h, HubsGraph& hubs)
  {
    ...
    return stapl::page_rank_h(g, h, hubs, m_num_iter);
  }
