...
/// (@ref pseudo_diameter(GView, HView),
/// @ref pseudo_diameter(GView, HView, HubsView)) for better scalability.
//////////////////////////////////////////////////////////////////////
...
struct pd_helper
{
  ...
  size_t operator()(Graph& g)
  {
    ...
    return stapl::pseudo_diameter(g);
  }
...
struct pd_h_helper
{
  ...
  size_t operator()(Graph& g, HGraph& h)
  {
    ...
    return stapl::pseudo_diameter(g, h);
  }
...
struct pd_hubs_helper
{
  ...
  size_t operator()(Graph& g, HGraph& h, HubsGraph& hubs)
  {
    ...
    return stapl::pseudo_diameter(g, h, hubs);
  }
