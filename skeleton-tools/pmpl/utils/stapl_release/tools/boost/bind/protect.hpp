...
// File differs from Boost 1.53 distribution by providing define_type methods
// to allow data structures defined here to be serialized by the STAPL runtime
// system and sent as parameters to remote method invocations.
