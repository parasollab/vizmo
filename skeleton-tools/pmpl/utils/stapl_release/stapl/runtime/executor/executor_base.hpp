...
public:
  ...
  /////////////////////////////////////////////////////////////////////
  /// @brief Sets the notifier to be called when the executor becomes runnable.
  //////////////////////////////////////////////////////////////////////
  template<typename RunnableFunction>
  void set_deferred_notifier(RunnableFunction&& rf)
  {
