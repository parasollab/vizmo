...
public:
  ...
  //////////////////////////////////////////////////////////////////////
  static collective& create(id const&, topology const&);

  //////////////////////////////////////////////////////////////////////
  /// @brief Notifies that @p m has arrived from a child process for collective
  ///        @p cid.
  //////////////////////////////////////////////////////////////////////
  static void notify_arrival(id const& cid, message_ptr m);
...
private:
  //////////////////////////////////////////////////////////////////////
  /// @brief Notifies that @p m has arrived from a child process.
  //////////////////////////////////////////////////////////////////////
  void notify_arrival(message_ptr m)
  {
...
public:
  ...
  message_slist collect(Function&& f)
  {
    const auto num_waiting = m_topology.children().size();
