...
{
  void operator()(std::tuple<Elements...> const& elements,
  ...
  void operator()(std::tuple<Elements...>& elements,
                  Functor const& f) const
  {
    for_each_impl<Num - 1, Functor, Elements...>()(elements, f);
...
{
  void operator()(std::tuple<Elements...> const&, Functor const&) const
  { }

  void operator()(std::tuple<Elements...>&, Functor const&) const
  { }
};
...
//////////////////////////////////////////////////////////////////////
template<typename Functor, typename ...Elements>
void for_each(std::tuple<Elements...> const& elements, Functor const& f)
{
...
//////////////////////////////////////////////////////////////////////
template<typename Functor, typename ...Elements>
void for_each(std::tuple<Elements...>& elements, Functor const& f)
{
  const size_t size = sizeof...(Elements);
