...
std::ostream&
print_tuple(std::ostream& os, std::tuple<Args...> const& t)
{
  os << "(";
  print_tuple_impl<
    std::tuple<Args...>, 0, sizeof...(Args)-1>::apply(os, ", ", t);
  return os << ")";
}
...
template<typename ...Args>
std::ostream&
print_tuple(std::ostream& os, std::string sep, std::tuple<Args...> const& t)
{
  os << "(";
  print_tuple_impl<
    std::tuple<Args...>, 0, sizeof...(Args)-1>::apply(os, sep, t);
  return os << ")";
}

//////////////////////////////////////////////////////////////////////
/// @brief Fallback implementation of print_tuple for a non-tuple argument.
