...
struct get_partitioner<segmented_view<C,PS,MFG,SV> >
{
  typedef PS type;
};
...
///        the given view is a partitioned view.
//////////////////////////////////////////////////////////////////////
template<typename C, typename PS, typename MFG, typename SV, typename GID>
localize_element<
  segmented_view<C,PS,MFG,SV>,
  GID,
  typename select_stub<segmented_view<C,PS,MFG,SV>,GID,PS>::type
>
localize_ref(segmented_view<C,PS,MFG,SV> const& vw, GID const& i)
{
  typedef typename select_stub<
    segmented_view<C, PS, MFG, SV>, GID, PS
  >::type stub_t;

return localize_element<segmented_view<C,PS,MFG,SV>,
                          GID,
                          stub_t>(vw,i);
}
