...
public:
  ...
  using return_type = md_container_type;
...
private:
  ...
  {
    stapl_assert(false,
      "Metadata extraction for a view from a different gang.");
...
public:
  ...
  return_type* operator()(distribution_type* dist) const
  {
    ...
    return_type* md_cont = new md_container_type(num_comp);
