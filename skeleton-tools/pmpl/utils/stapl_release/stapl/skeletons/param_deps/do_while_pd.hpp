...
class do_while_pd
{
  skeletons_impl::do_while_stubs<ContCond> m_wf;

public:
  typedef std::integral_constant<int, 1> in_port_size;
               ...
               Visitor& visitor, In&& in_flow) const
  {
    visitor(m_wf,
            ...
            reflexive_input<true>(visitor.get_memento_stack()));
  }
