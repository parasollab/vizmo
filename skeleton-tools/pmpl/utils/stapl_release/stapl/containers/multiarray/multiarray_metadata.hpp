...
template<typename Distribution,
  bool = tuple_size<typename Distribution::partition_type::index_type>::value ==
         tuple_size<typename Distribution::gid_type>::value>
...
class multiarray_extractor<Distribution, true>
 : public container_extractor_base<
     multiarray_extractor<Distribution, true>
   >
{
...
class multiarray_extractor<Distribution, false>
 : public container_extractor_base<
     multiarray_extractor<Distribution, false>
   >
{
