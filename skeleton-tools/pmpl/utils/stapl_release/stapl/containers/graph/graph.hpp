...
public:
  ...
  {
    return this->distribution().num_edges();
  }
  ...
  {
    return this->distribution().num_edges_collective();
  }
  ...
  {
    return this->distribution().num_local_edges();
  }
...
public:
  ...
  /// This is a non-blocking, non-collective version of num_edges.
  /// For faster collective, use num_edges_collective() below.
  /// @return size_t number of edges in the pGraph.
  //////////////////////////////////////////////////////////////////////
  size_t num_edges(void) const
  {
    return this->distribution().num_edges() / 2;
  }
  ...
  size_t num_edges_collective(void) const
  {
    return this->distribution().num_edges_collective() / 2;
  }
