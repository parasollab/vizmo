...
/// @ingroup pgUtility
//////////////////////////////////////////////////////////////////////
template <typename Factory, bool stat = has_tag_type<Factory>::value>
struct tag_type
{
  typedef typename Factory::tag_type type;
};
...
{
  typedef stapl::use_default type;
};
...
{
  typedef typename Factory::coarsener_type type;
};
