...
static const char qt_meta_stringdata_Camera[] = {
    "Camera\0\0_delta\0Translate(Vector3d)\0"
    "_axis,_theta\0Rotate(Vector3d,double)\0"
};
...
void Camera::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->Translate((*reinterpret_cast< const Vector3d(*)>(_a[1]))); break;
        case 1: _t->Rotate((*reinterpret_cast< const Vector3d(*)>(_a[1])),(*reinterpret_cast< double(*)>(_a[2]))); break;
        default: ;
        }
    }
}
