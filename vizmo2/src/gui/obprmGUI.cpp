...
void obprmGUI::LP2(){
  lbLP->insertItem("rotate_at_s "+lp_rotate->text()+" ");
}
...
void obprmGUI::setupTabFile(){
  ...
  addTab (main, QIconSet(icon_folder), "General");

}

void obprmGUI::setupTabBbox(){

  QGrid*grid = new QGrid(3, QGrid::Vertical, this);
  grid->setPaletteBackgroundColor(QColor(238, 232, 170));
  grid->setMargin(50);
  grid->setSpacing(4);
 
  bGrp = new QButtonGroup(0);
...
// 				 Qt::AlignCenter);
  ...
  lbMethod = new QListBox(basicWidgt);
  lbMethod->setPaletteForegroundColor(blue);
  ...
  QPushButton *acceptMethod = new QPushButton(QIconSet(icon_clip), 
  ...
  lbMethod->insertItem("BasicPRM 10");
...
void obprmGUI::setupTabLp(){
  ...
  pb = new QPushButton(QIconSet(icon_clip), "straightline", main);
  ...
  pb = new QPushButton(QIconSet(icon_clip), "rotate_at_s", main);
  ...
  pb = new QPushButton(QIconSet(icon_clip), "a_star_dist",main);
  ...
  pb = new QPushButton(QIconSet(icon_clip), "a_star_clearance", 
  ...
  pb = new QPushButton(QIconSet(icon_clip), "approx_spheres",main);
  ...
  label->setPaletteForegroundColor(darkGreen);
  label->setFrameStyle( QFrame::Panel | QFrame::Sunken);
  label->setText( "Double click to delete an item" );
  label->setAlignment(AlignHCenter);
  QFont f;
...
void obprmGUI::setupTabCD(){
  ...
  QGrid *grid = new QGrid(2, QGrid::Vertical, this);
  ...
  QGrid* g = new QGrid(2,QGrid::Horizontal,grid);
  g->setFrameStyle( QFrame::Box | QFrame::Plain);
  g->setSpacing(5);
  g->setMargin(50);

  bg_cd = new QButtonGroup(0);
  QRadioButton *b_cd;
...
void obprmGUI::addBoxes(QGrid *grid){

  QGrid* g = new QGrid(6,QGrid::Horizontal,grid);
...
void obprmGUI::createCNodesGUI(){
  ...
  pbCN = new QPushButton(QIconSet(icon_clip),"random",main);
  grid->addWidget(pbCN, 0, 0);
  connect(pbCN, SIGNAL(clicked()), this, SLOT(addRandom()) );

  pbCN = new QPushButton(QIconSet(icon_clip),"closest",main);
  ...
  pbCN = new QPushButton(QIconSet(icon_clip),"closestVE",main);
  ...
  pbCN = new QPushButton(QIconSet(icon_clip),"components",main);
  ...
  pbCN = new QPushButton(QIconSet(icon_clip),"obstBased",main);
  ...
  pbCN = new QPushButton(QIconSet(icon_clip),"RRTexpand",main);
  ...
  pbCN = new QPushButton(QIconSet(icon_clip),"RRTcomponents",main);
  ...
  pbCN = new QPushButton(QIconSet(icon_clip),"RayTracer",main);
...
;
  ...
  pbCN = new QPushButton(QIconSet(icon_clip),"modifiedLM",main);
  ...
  lbCnodes = new QListBox(main);
  lbCnodes->setPaletteForegroundColor(blue);
...
void obprmGUI::createElemtsObprm(){
  ...
  l_collPair->setAlignment (AlignVCenter);
...
void obprmGUI::createFileDialog(){
  ...
  fileDialog =  new obprmFileSelectDialog (this,"fileSelectDialog",true);
...
obprmFileSelectDialog::obprmFileSelectDialog
(QWidget *parent, const char *name, WFlags f)
:QDialog(parent,name,f)
{
  ...
  QPushButton * envButton = new QPushButton(QIconSet(icon_folder),"Browse",this);  
  ...
  QPushButton * inButton = new QPushButton(QIconSet(icon_folder),"Browse",this);  
  ...
  QPushButton * outButton = new QPushButton(QIconSet(icon_folder),"Browse",this);  
...
textEditDialog::textEditDialog(QWidget *parent, const char *name, WFlags f)
...
void textEditDialog::createFile(){
  ...
  fn = QFileDialog::getSaveFileName( QString::null, tr( "All Files (*)" ), this );
  if ( !fn.isEmpty() ) {
